                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contacts.update', $contact->contactID) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="company" type="text" class="form-control @error('company') is-invalid @enderror" name="company" value="{{ $contact->company }}" required autocomplete="company" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $contact->phone }}" required autocomplete="phone" autofocus>
